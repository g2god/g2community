...
signup=Button(root,text="Sign up",fg="blue",bg="#FFFFFF",bd=0,font=("Microsoft yaHei UI Light",10),activebackground="#FFFFFF",activeforeground="yellow").place(x=380,y=515)
